...
//                    	System.out.println(message.getMessageID().getPeerID().peerName);
                    ...
                    /////////////////////Akshay Bhagdikar//////////////////////////
                       ...
                       //Co-ordinator node checks if this node is alive
                       PrintWriter pw = new PrintWriter(os, true);
                       pw.println("hello back");
                    }
                    
                    else if("broadcast".equals(command)) {
//System.out.println("transmitted");
			String msgId = message.getBrdMsgId();
			if(!(broadcaster.msgStore.contains(msgId))) {
                        System.out.println("Broadcasted message from " + message.getOriginator() + ": "+message.getBrdMsg());
...
//System.out.println("message id received "+ msgId);
